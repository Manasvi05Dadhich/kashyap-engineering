    ...
    <section className="relative isolate overflow-hidden bg-[#073b72] text-white">
      ...
      <div className="mx-auto grid min-h-[620px] max-w-7xl items-center px-6 py-24 lg:grid-cols-[.95fr_1.05fr] lg:px-10">
        <div className="relative z-10 max-w-2xl">
          ...
          <h1 className="reveal-up font-display text-5xl font-extrabold leading-[1.02] tracking-[-.04em] [animation-delay:100ms] sm:text-6xl lg:text-7xl">Precision machinery for better production.</h1>
          <p className="reveal-up mt-7 max-w-lg text-base leading-7 text-blue-50/85 [animation-delay:200ms] sm:text-lg">Reliable liquid, oil, bottle and tube filling systems engineered for your line, your product and your next stage of growth.</p>
